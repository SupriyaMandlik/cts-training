...
public class EmployeeController {
	...
	do {
		...
		List<Employee1> list = empObj.getAllEmployees();
		...
		case 1:
			...
			Employee1 emp = new Employee1(id, nm, ad, dsg, ag, sal, mob);
		...
		case 2:
			...
			Employee1 obj = empObj.getEmployeeById(del);
		...
		case 3:
			...
			Employee1 obj1 = empObj.getEmployeeById(up);
		...
		case 4:
			...
			Employee1 obj2 = empObj.getEmployeeById(data);
